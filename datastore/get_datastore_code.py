...
def get_stack_data_files(large_datastore: bool):
    segment = 30 if large_datastore else 1 # Maximum number of segment: 144
    data_files = []
...
if __name__ == "__main__":
    ...
    dataset = load_dataset('bigcode/the-stack-dedup', \
        data_dir='data/python', split='train', data_files=get_stack_data_files(args.large_datastore))
