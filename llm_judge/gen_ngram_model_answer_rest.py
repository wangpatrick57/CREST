...
from ngram_datastore.utils import generate_ngram_candidates_and_draft_buffer
from ngram_datastore.ngram_datastore import NGramDatastoreBuilder, NGramDatastore

datastore_path = "/home/ubuntu/REST/datastore/datastore_chat_small.idx"
...
# ngram_datastore = NGramDatastoreBuilder(dataset_name, num_conversations, model_path, reader, ngram_n, num_top_ngrams).load_or_build()
...
def rest_forward(input_ids, model, tokenizer, max_new_token, temperature, top_p, datastore, num_draft, token_spans, max_steps=1024):
    print("in the rest forward function")
...
def get_model_answers(
    ...
    accept_lengths_tree = []
    for question in tqdm(questions[:3]):
